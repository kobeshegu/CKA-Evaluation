...
parser.add_argument('--save_dir', default="/mnt/lustre/yangmengping/mocov3/R50", type=str,
                    help='save dir')
parser.add_argument('--data_dir', default="celeba_hq", type=str,
                    help='data dir')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # Data loading code
    traindir = os.path.join(args.data, args.data_dir)
    ...
    for epoch in range(args.start_epoch, args.epochs):
	 ...
	 # only the first GPU saves checkpoint
            if (epoch+1) % 50 == 0:
                ...
                }, is_best=False, filename='checkpoint_%04d.pth.tar'%(epoch+1), save_dir=args.save_dir)
