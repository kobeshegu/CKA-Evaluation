...
@click.option('--metrics', help='Quality metrics', metavar='[NAME|A,B,C|none]', type=parse_comma_separated_list, default='gmlp_fid50k_full,gmlp_kid50k_full,gmlp_cka50k_full', show_default=True)
@click.option('--data', help='Dataset to evaluate against  [default: look up]', default="D:/Z-kobeshegu/NeurIPS2023-rebuttal/ffhq256x256.zip", metavar='[ZIP|DIR]', show_default=True)
@click.option('--generate', help='Generated dataset to evaluate', default="D:/Z-kobeshegu/NeurIPS2023-rebuttal/match_inception_ffhq_final.zip", metavar='[ZIP|DIR]', show_default=True)
...
@click.option('--layers', help='Which layer to get features', type=parse_comma_separated_list, default="blocks.2,blocks.5,blocks.8,blocks.11,blocks.14,blocks.20", metavar='STRING', show_default=True)
...
@click.option('--save_res', help='Where to save the results of computed metrics', type=str, default='D:/Z-kobeshegu/NeurIPS2023-rebuttal/gmlp_match_inception', metavar='STRING', show_default=True)
...
@click.option('--max_real', help='The max number of realdataset for computation', type=int, default=70000, metavar='INT', show_default=True)
