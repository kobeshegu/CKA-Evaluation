...
@click.option('--metrics', help='Quality metrics', metavar='[NAME|A,B,C|none]', type=parse_comma_separated_list, default='gmlp_kid50k_full,gmlp_cka50k_full', show_default=True)
...
@click.option('--save_res', help='Where to save the results of computed metrics', type=str, default='D:/Z-kobeshegu/NeurIPS2023-rebuttal/gmlp_random', metavar='STRING', show_default=True)
