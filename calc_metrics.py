...
@click.option('--data', help='Dataset to evaluate against  [default: look up]', default="./datasets/ffhq-1024x1024.zip", metavar='[ZIP|DIR]', show_default=True)
@click.option('--generate', help='Generated dataset to evaluate', default=None, metavar='[ZIP|DIR]', show_default=True)
...
@click.option('--save_res', help='Where to save the results of computed metrics', type=str, default='/mnt/petrelfs/yangmengping/results', metavar='STRING', show_default=True)
@click.option('--feature_save', help='Where to save the features of different dataset', type=str, default='/mnt/petrelfs/yangmengping/features', metavar='STRING', show_default=True)
...
@click.option('--save_name', help='Which file to save the results of computed metrics', type=str, default='num_gen5000', metavar='STRING', show_default=True)
@click.option('--max_real', help='The max number of realdataset for computation', type=int, default=50000, metavar='INT', show_default=True)
