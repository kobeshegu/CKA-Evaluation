...
@click.option('--metrics', help='Quality metrics', metavar='[NAME|A,B,C|none]', type=parse_comma_separated_list, default='mixermlp_fid50k_full,mixermlp_kid50k_full,mixermlp_cka50k_full', show_default=True)
...
@click.option('--layers', help='Which layer to get features', type=parse_comma_separated_list, default="blocks.2,blocks.5,blocks.8,blocks.11", metavar='STRING', show_default=True)
...
@click.option('--save_res', help='Where to save the results of computed metrics', type=str, default='D:/Z-kobeshegu/NeurIPS2023-rebuttal/mixermlp_random', metavar='STRING', show_default=True)
...
@click.option('--save_name', help='Which file to save the results of computed metrics', type=str, default='mixermlp_random', metavar='STRING', show_default=True)
